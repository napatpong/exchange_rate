...
async function exportKbankRatesToPDF() {
  ...
  try {
    ...
    const roundInfo = await page.evaluate(() => {
      ...
      // ลองหาในรูปแบบ "เวลา 13:10:38", "13:10:38", หรือ "ล่าสุดคือ วันที่ xx เวลา 13:10:38"
      const timePatterns = [
